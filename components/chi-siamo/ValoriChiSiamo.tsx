      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-16">
        ...
        >
          <Link
            ...
            className="inline-flex items-center gap-2 font-label text-[11px] uppercase tracking-[0.15em] bg-primary text-background rounded-full px-7 py-3 hover:bg-primary/85 transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-background"
          >
            Investimenti immobiliari <span aria-hidden="true">&rarr;</span>
          </Link>
          <Link
            href="/servizi/nuove-costruzioni"
            className="inline-flex items-center gap-2 font-label text-[11px] uppercase tracking-[0.15em] border border-primary/40 text-primary rounded-full px-7 py-3 hover:bg-primary hover:text-background transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            Nuove costruzioni <span aria-hidden="true">&rarr;</span>
          </Link>
        </motion.div>
      </div>
    </section>
